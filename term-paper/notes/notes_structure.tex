...
\subsection{Preprocessing} % Total of 6 + 2 + 1 = 9 Pages
...
\subsubsection{Manual Feature Selection} % 2 Pages


\subsubsection{Encoding and Automatic Feature Selection} % 1 Page
%%%
\begin{itemize}
