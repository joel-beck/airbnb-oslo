...
The source code that produced all results, figures and tables is provided by our GitLab Repository\footnote{\url{https://gitlab.gwdg.de/joel.beck/airbnb-oslo}}.
