...
def main():
    ...
    munich_listings: pd.DataFrame = pd.read_csv(
        "munich_listings.csv.gz", index_col="id"
    )
    ...
    munich_listings_clean.convert_dtypes().to_pickle(
        "../../data/munich/munich_listings.pkl"
    )
