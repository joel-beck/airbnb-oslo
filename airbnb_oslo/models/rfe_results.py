...
from airbnb_oslo.helpers.pytorch_helpers import MLP
...
def main():
    ...
    if MUNICH:
        ...
        neural_network_path = "../../data/results/munich_neural_network_rfe_results.pkl"
        complete_results_path = "../../data/results/munich_complete_rfe_results.pkl"
        ...
        X_test_path = "../../data/munich/munich_X_test.pkl"
        y_test_path = "../../data/munich/munich_y_test.pkl"
        fig_coefficient_path = "../../term-paper/images/munich_coefficient_plot.png"
        mlp_weights_path = "../../data/weights/munich_mlp_weights_None.pt"
        ...
        classical_models_path = "../../data/results/classical_models_rfe_results.pkl"
        neural_network_path = "../../data/results/neural_network_rfe_results.pkl"
        complete_results_path = "../../data/results/complete_rfe_results.pkl"
        ...
        X_test_path = "../../data/clean/X_test.pkl"
        y_test_path = "../../data/clean/y_test.pkl"
        fig_coefficient_path = "../../term-paper/images/coefficient_plot.png"
        mlp_weights_path = "./../data/weights/mlp_weights_None.pt"
    ...
    log_transform = TransformedTargetRegressor(
    ...
    randomforest = RandomForestRegressor(
        n_estimators=6, min_samples_leaf=4, max_depth=5
    )
    ...
    X_tensor_test = torch.tensor(
        column_transformer.transform(X_test).astype(np.float32)
    )
    ...
    top3_average = np.mean(
        [ridge_predictions, linearreg_predictions, histgradientboosting_predictions],
        axis=0,
    )
