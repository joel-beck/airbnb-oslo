...
from airbnb_oslo.helpers.pytorch_helpers import MLP, run_regression
...
def main():
    ...
    if MUNICH:
        ...
        mlp_results_path = "../../data/results/munich_neural_network_outliers.pkl"
        classical_models_results_path = (
            "../../data/results/munich_classical_models_outliers.pkl"
        )
        table_outliers_path = "../../term-paper/tables/munich_table_outliers.csv"
        outlier_results_path = "../../data/results/munich_outlier_results.pkl"
    else:
        X_train_val_path = "../../data/clean/X_train_val.pkl"
        y_train_val_path = "../../data/clean/y_train_val.pkl"
        mlp_results_path = "../../data/results/neural_network_outliers.pkl"
        classical_models_results_path = (
            "../../data/results/classical_models_outliers.pkl"
        )
        table_outliers_path = "../../term-paper/tables/table_outliers.csv"
        outlier_results_path = "../../data/results/outlier_results.pkl"
    ...
    classical_models_results = pd.concat(quantile_threshold_results).sort_values(
        "mae_val"
    )
