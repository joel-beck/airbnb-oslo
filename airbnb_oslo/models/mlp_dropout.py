...
from airbnb_oslo.helpers.sklearn_helpers import ResultContainer, get_column_transformer
...
def main():
    ...
    fig, axes = plt.subplots(
        nrows=2, ncols=2, figsize=(12, 12), sharey="row", sharex=True
    )
    ...
    lgd = ax2.legend(
        title="Dropout Probability", bbox_to_anchor=(1.4, 0.2), frameon=False
    )
